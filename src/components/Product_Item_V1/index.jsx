    ...
    return(
        <div className='product_item_v1'>
            ...
            <div className='info text-center'>
                <h4 className="mt-2 font-weight-bold">Bigti Burger</h4>
                <p className="text-black/60 mt-2 mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit mollitia delectus numqua.</p>
                <Button><IoCartOutline /> Comprar</Button>
            </div>
        </div>
    )
